                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-4" id="autre">
                        ...
                        <div class="card bg-dark actu" style="width: 18rem;">
                            <div class="card-body ">
                                <h5 class="card-title"><?php if(!$lang) {echo "Actualités :";} else if ($lang == "eng") {echo "Actualities :";}?></h5>
